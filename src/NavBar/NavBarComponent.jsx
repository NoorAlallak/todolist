  ...
  return (
    <div>
      <div className="w-full  bg-[#3bc6b4] p-2 shadow-md flex flex-row items-start justify-start h-18 ">
        ...
        <button
          onClick={handleLogin}
          className="ml-auto bg-white text-[#3bc6b4] font-semibold px-3 py-1 rounded hover:bg-gray-200 cursor-pointer my-2"
        >
          LogIn
        </button>
        <button
          onClick={handleSignUp}
          className="ml-4 bg-white text-[#3bc6b4] font-semibold px-3 py-1 rounded hover:bg-gray-200 cursor-pointer my-2"
        >
          SignUp
        </button>
      </div>
